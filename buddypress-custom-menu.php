...
function create_bp_custom_menu_page_post_type() {
    register_post_type( 'bp_custom_menu_page',
      array(
        'labels' => array(
          'name' => __( 'BuddyPress Custom Menu Pages' ),
          'menu_name' => __( 'BP Custom Menu' ),
          'singular_name' => __( 'BuddyPress Custom Menu Page' ),
          'add_new' => __( 'Add New' ),
          'add_new_item' => __( 'Add New Menu Page' ),
          'edit_item' => __( 'Edit BuddyPress Custom Menu Page' ),
          'new_item' => __( 'New Menu Page' ),
          'view_item' => __( 'View Menu Page' ),
          'search_items' => __( 'Search Menu Pages' ),
          'not_found' => __( 'No Menu Pages found' ),
          'not_found_in_trash' => __( 'No Menu Pages found in trash' ),
          'parent_item_colon' => __( 'Parent Menu Page:' ),
          'all_items' => __( 'All Menu Pages' ),
          'attributes' => __( 'Menu Page Attributes' ),
        ),
        'public' => false,
        'has_archive' => false,
        'show_ui' => true,
